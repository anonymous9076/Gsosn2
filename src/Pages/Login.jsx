    ...
    <Container>
        <div className='lg:px-72 py-8'>
            <div className='bg-[#ececec] px-2 sm:px-4 md:px-10 py-10 flex flex-col gap-8 rounded-lg'>
                <h1 className='text-[28px] sm:text-[42px]'>Log in to your account</h1>
                <div className='flex flex-col gap-2'>
                    <h3 className='text-[18px] font-medium'>Email/username</h3>
                ...
                <div className='flex justify-center'>
                    <h3 className='text-[16px] text-[#7f7f7f] font-medium'>Don't have an account? <Link to='/signup'><span className='text-[#c7a379] cursor-pointer hover:text-red-800 duration-200'>Register</span></Link></h3>
                </div>
            </div>
            </div>
    </Container>
